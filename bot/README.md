...
3. Create a `.env` file in this directory with your bot token:
   ...
   PORT=3001
   WEB_APP_URL=https://your-production-url.com/emotional-burnout-detector.io/
   ```
4. For local development, you can use a placeholder URL:
   ```
   WEB_APP_URL=https://your-development-url.com/emotional-burnout-detector.io/
   ```
   Note: For local testing, you'll need to use a service like ngrok to expose your local server with HTTPS.
...
- `WEB_APP_URL`: URL of the frontend application (default: https://your-production-url.com/emotional-burnout-detector.io/)
...
- Weekly wellness tips (every 7 days)
